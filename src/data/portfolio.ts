...
export const projects = [
  {
    id: 0,
    title: "UPA Agora",
    description: "Sistema desenvolvido para a Prefeitura de Betim. Painel público em tempo real das 4 UPAs do município. Exibe fila de espera por especialidade, classificação de risco pelo Protocolo de Manchester, tempo médio de espera, contagem de pacientes por etapa (recepção → triagem → atendimento → reavaliação) e status online/offline de cada unidade. Suite completa de acessibilidade: VLibras, narrador de voz, alto contraste e zoom.",
  ...
  },
  {
    ...
    description: "Sistema desenvolvido para a Prefeitura de Betim. Portal público das regionais administrativas do município. Cidadãos consultam equipamentos de cada regional — praças, escolas, teatros, espaços de lazer — e abrem solicitações online de serviços urbanos como tapa-buraco, poda de árvores, capina e iluminação pública. Notificações de status por e-mail via Resend.",
  ...
  },
  {
    id: 2,
    title: "Fundação Beta",
    description: "Site institucional da Fundação Beta, centro de inovação e tecnologia da Prefeitura de Betim. Apresenta os 21+ projetos ativos, pilares estratégicos, visão Beta30+ (2025–2055) e canais de contato com a fundação que aproxima o governo do cidadão através de soluções digitais.",
  ...
  },
  {
    id: 4,
    title: "Tudo Em Dia",
    description: "SaaS de gestão financeira pessoal para o mercado brasileiro. Controle de contas, cartões de crédito, transações parceladas, metas, despesas recorrentes e relatórios. Dashboard com score de saúde financeira (0–1000), previsão de saldo e 'Seguro Gastar Hoje'. Assistente de IA com voz para CRUD por linguagem natural. Planos Free e Premium com pagamento via Stripe (cartão, boleto e PIX).",
    tech: ["Next.js 16", "React 19", "TypeScript", "Tailwind CSS v4", "Firebase", "OpenAI", "Stripe", "Vercel AI SDK", "Framer Motion", "GSAP"],
    github: null,
